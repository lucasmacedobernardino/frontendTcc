...
export default function RankingPortugues() {
    const [ranking, setRanking] = useState([{}])
    const [top3, setTop3] = useState([{}])
    const fetchRanking = async () => {
        try {

            const response = await fetch(`${ip}/usuarioresposta/rankingPortugues/`, {
                method: 'GET',
                headers: {
    ...
    return (
        <div className="flex items-center justify-center">
            <div className="p-7 bg-[#B2DCEC] h-auto w-auto">
                ...
                <div className='flex justify-center items-center translate-x-2 mt-1 -translate-y-10'>
                    <Image src='/assets/mago_portugues_svg.svg' alt='Mago de português' height={169} width={169} />
                </div>
