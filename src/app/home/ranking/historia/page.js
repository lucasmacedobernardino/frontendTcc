...
export default function RankingHistoria() {
    const [ranking, setRanking] = useState([{}])
    const [top3, setTop3] = useState([{}])
    const fetchRanking = async () => {
        try {

            const response = await fetch(`${ip}/usuarioresposta/rankingHistoria/`, {
                method: 'GET',
                headers: {
    ...
    return (
        <div className="flex items-center justify-center">
            <div className="p-7 bg-[#E6EDAD] h-auto w-auto">
                ...
                <div className='flex justify-center items-center translate-x-2 mt-1 -translate-y-10'>
                    <Image src='/assets/mago_historia_svg.svg' alt='Mago de história' height={169} width={169} />
                </div>
