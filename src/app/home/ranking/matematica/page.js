...
export default function RankingMatematica() {
    ...
    const fetchRanking = async () => {
        try {
            ...
            const response = await fetch(`${ip}/usuarioresposta/rankingMatematica/`, {
                method: 'GET',
                headers: {
    ...
    return (
        <div className="flex items-center justify-center">
            <div className="p-7 bg-[#ECB2B2] h-auto w-auto">
                ...
                <div className='flex justify-center items-center translate-x-2 mt-1 -translate-y-10'>
                    <Image src='/assets/mago_matematica_svg.svg' alt='Mago de matemática' height={169} width={169} />
                </div>
